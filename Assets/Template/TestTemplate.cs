...
namespace Project.Test
{
    public class TestTemplate : ITemplate
    {
        public void Build(CanvasBuilderFactory canvasBuilderFactory)
        {
            ...
            canvasBuilder1.Button.Text("Remove canvas").Position(0,-40).Size(100,20).Click("Project.Test.RemoveCanvasController","RemoveCanvases",2);
            ...
            canvasBuilder2.Button.Text("Open canvas").Position(0,-140).Size(100,20)
                .Click("Project.Test.TestBController","UnitPanel");
        }
    }
}